...
public class OrderController {
    ...
    public OrderResponseDto completeOrder(Authentication authentication) {
        ...
        ShoppingCart cart = shoppingCartService.getByUser(
                userService.findByEmail(name).orElseThrow(() ->
                        new RuntimeException("Can't get user by email -> " + name)));
    ...
    public List<OrderResponseDto> getOrderHistory(Authentication authentication) {
        String name = authentication.getName();
        return orderService.getOrdersHistory(userService.findByEmail(name).orElseThrow(() ->
                new RuntimeException("Can't get user by email -> " + name)))
                .stream()
