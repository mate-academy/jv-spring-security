...
public class OrderController {
    ...
    public OrderResponseDto completeOrder(Authentication authentication) {
        ...
        ShoppingCart cart = shoppingCartService
                .getByUser(userService.findByEmail(userEmail)
                        .orElseThrow(() ->
                                new NoSuchElementException("There is no such Email " + userEmail)));
    ...
    public List<OrderResponseDto> getOrderHistory(Authentication authentication) {
        String userEmail = authentication.getName();
        return orderService.getOrdersHistory(userService.findByEmail(userEmail)
                        .orElseThrow(() ->
                 new NoSuchElementException("There is no such Email " + userEmail)))
                .stream()
