...
public class OrderController {
    ...
    public OrderResponseDto completeOrder(Authentication authentication) {
        ...
        ShoppingCart cart = shoppingCartService.getByUser(optionalUser
                .orElseThrow((() -> new NoSuchElementException("Can't complete an order"))));
    ...
    public List<OrderResponseDto> getOrderHistory(Authentication authentication) {
        Optional<User> optionalUser = userService.findByEmail(authentication.getName());
        return orderService.getOrdersHistory(optionalUser
                        .orElseThrow((() -> new NoSuchElementException(
                                "Can't get order history"))))
                .stream()
