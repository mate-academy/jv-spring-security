...
public class ShoppingCartController {
    ...
    public void addToCart(Authentication authentication, @RequestParam Long movieSessionId) {
        shoppingCartService.addSession(
                ...
                userService.findByEmail(
                        ...
                        new DataProcessingException("Can't find a user: "
                                + authentication.getName() + " and add Movie Session to Cart")));
    }
    ...
    public ShoppingCartResponseDto getByUser(Authentication authentication) {
        User user = userService.findByEmail(
                authentication.getName()).orElseThrow(() ->
                new DataProcessingException("Cant' find a user: "
                        + authentication.getName() + " and get Shopping Cart"));
