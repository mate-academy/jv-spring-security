...
public class ShoppingCartController {
    ...
    public void addToCart(Authentication authen, @RequestParam Long movieSessionId) {
        shoppingCartService.addSession(
                movieSessionService.get(movieSessionId),
                userService.findByEmail(authen.getName()).get());
    }

    @GetMapping("/by-user")
    public ShoppingCartResponseDto getByUser(Authentication authen) {
        User user = userService.findByEmail(authen.getName()).get();
