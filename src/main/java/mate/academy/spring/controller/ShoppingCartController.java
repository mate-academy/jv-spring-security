...
public class ShoppingCartController {
    ...
    public void addToCart(Authentication authentication, @RequestParam Long movieSessionId) {
        ...
        shoppingCartService.addSession(
                movieSessionService.get(movieSessionId), userService.findByEmail(name)
                        .orElseThrow(()
                                -> new NoSuchElementException("Can't find user by email" + name)));
    }
        ...
        return shoppingCartResponseDtoMapper
                .mapToDto(shoppingCartService
                        .getByUser(userService.findByEmail(name)
                                .orElseThrow(()
                                        -> new NoSuchElementException("Can't "
