...
public class ShoppingCartController {
    ...
    public void addToCart(@RequestParam @Valid Authentication authentication,
    ...
    @GetMapping("/by-user")
    public ShoppingCartResponseDto getByUser(@RequestParam @Valid Authentication authentication) {
