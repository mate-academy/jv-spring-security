...
public class MovieSessionController {
    ...
    @PostMapping
    public MovieSessionResponseDto add(@Valid @RequestBody MovieSessionRequestDto requestDto) {
    ...
    public List<MovieSessionResponseDto> getAll(@RequestParam @PositiveOrZero Long movieId,
                                                @RequestParam
    ...
    @PutMapping("/{id}")
    public MovieSessionResponseDto update(@PathVariable @PositiveOrZero Long id,
                                          @Valid @RequestBody MovieSessionRequestDto requestDto) {
        MovieSession movieSession = movieSessionMapper.mapToModel(requestDto);
