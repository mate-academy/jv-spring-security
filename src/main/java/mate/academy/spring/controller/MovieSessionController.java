...
public class MovieSessionController {
    ...
    public List<MovieSessionResponseDto> getAll(@RequestParam @NotNull @Min(1) Long movieId,
                                                @RequestParam
    ...
    @PutMapping("/{id}")
    public MovieSessionResponseDto update(@PathVariable @NotNull @Min(1) Long id,
